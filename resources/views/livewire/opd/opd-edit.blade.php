            ...
            <form wire:submit="update">
                ...
                <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 gap-4">
                    ...
                    <div class="form-control lg:col-span-2">
                        ...
                        <input type="text" wire:model="name" class="input w-full @error('name') input-error @enderror" placeholder="Masukkan nama OPD">
                        @error('name')
                            <label class="label">
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" wire:model="singkatan" class="input w-full @error('singkatan') input-error @enderror" placeholder="Masukkan singkatan">
                        @error('singkatan')
                            <label class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </label>
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" wire:model="telp" class="input w-full @error('telp') input-error @enderror" placeholder="Masukkan nomor telepon">
                        @error('telp')
                            <label class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </label>
                    ...
                    <div class="form-control lg:col-span-2">
                        ...
                        <textarea wire:model="alamat" class="textarea textarea-bordered w-full @error('alamat') textarea-error @enderror" rows="3" placeholder="Masukkan alamat lengkap"></textarea>
                        @error('alamat')
                            <label class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
                            </label>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            @else
                                <div class="avatar placeholder">
                                    <div class="bg-base-200 text-base-content/70 w-20 rounded-xl"></div>
                                </div>
                            @endif
                            <input type="file" wire:model="logo" class="file-input file-input-bordered w-full max-w-xs @error('logo') file-input-error @enderror" accept="image/*">
                        </div>
                        @error('logo')
                            <label class="label">
                                <span class="label-text-alt text-error">{{ $message }}</span>
